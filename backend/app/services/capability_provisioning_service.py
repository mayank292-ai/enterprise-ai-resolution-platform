...
class CapabilityProvisioningService:
    ...
    def provision(
        ...
        *,
        ...
        # Resolve and register the implementation before mutating the
        # persisted lifecycle state. An unsupported proposal must remain
        # retryable instead of becoming stranded in ``creating``.
