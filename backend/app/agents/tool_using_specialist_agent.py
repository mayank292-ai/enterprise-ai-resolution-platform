    ...
    async def investigate(
        ...
        *,
        ...
        for _ in range(self.MAX_TOOL_STEPS):
            ...
            for finish_repair_attempt in range(
                1,
                self.MAX_FINISH_REPAIR_ATTEMPTS + 1,
            ):
                if (
                    step.step_type != SpecialistStepType.FINISH
                    or step.final_result is not None
                ):
                    break
                ...
                print(
                    ...
                    f"{self.name} "
                    f"({finish_repair_attempt}/"
                    f"{self.MAX_FINISH_REPAIR_ATTEMPTS})."
                )
                ...
                repair_prompt = (
                    ...
                    f"This is repair attempt {finish_repair_attempt} of "
                    f"{self.MAX_FINISH_REPAIR_ATTEMPTS}."
                )
